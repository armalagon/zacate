...
public class SpanishNumber2LetterTest {
    ...
    public void testUnits() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(0).build();
        assertEquals("cero", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(3).build();
        assertEquals("tres", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(9).build();
    ...
    public void testTens() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(12).build();
        assertEquals("doce", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(15).build();
        assertEquals("quince", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(19).build();
        assertEquals("diecinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(20).build();
        assertEquals("veinte", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(26).build();
        assertEquals("veintiseis", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(29).build();
        assertEquals("veintinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(30).build();
        assertEquals("treinta", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(37).build();
        assertEquals("treintisiete", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(44).build();
        assertEquals("cuarenticuatro", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(48).build();
        assertEquals("cuarentiocho", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(51).build();
        assertEquals("cincuentiuno", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(59).build();
        assertEquals("cincuentinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(69).build();
        assertEquals("sesentinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(75).build();
        assertEquals("setenticinco", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(80).build();
        assertEquals("ochenta", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(92).build();
        assertEquals("noventidos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(99).build();
        assertEquals("noventinueve", converter.toLetter());
    }

    @Test
    public void testTensWithLongFormat() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(16).longFormat(true).build();
        assertEquals("diez y seis", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(19).longFormat(true).build();
        assertEquals("diez y nueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(23).longFormat(true).build();
        assertEquals("veinte y tres", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(29).longFormat(true).build();
        assertEquals("veinte y nueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(35).longFormat(true).build();
        assertEquals("treinta y cinco", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(69).longFormat(true).build();
        assertEquals("sesenta y nueve", converter.toLetter());
    }

    @Test
    public void testHundreds() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(100).build();
        assertEquals("cien", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(101).build();
        assertEquals("ciento uno", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(106).build();
        assertEquals("ciento seis", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(110).build();
        assertEquals("ciento diez", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(111).build();
        assertEquals("ciento once", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(115).build();
        assertEquals("ciento quince", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(125).build();
        assertEquals("ciento veinticinco", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(200).build();
        assertEquals("doscientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(266).build();
        assertEquals("doscientos sesentiseis", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(299).build();
        assertEquals("doscientos noventinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(300).build();
        assertEquals("trescientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(362).build();
        assertEquals("trescientos sesentidos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(400).build();
        assertEquals("cuatrocientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(500).build();
        assertEquals("quinientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(600).build();
        assertEquals("seiscientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(700).build();
        assertEquals("setecientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(800).build();
        assertEquals("ochocientos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(900).build();
        assertEquals("novecientos", converter.toLetter());
    }

    @Test
    public void testThousands() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(1000).build();
        assertEquals("un mil", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(1001).build();
        assertEquals("un mil uno", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(1007).build();
        assertEquals("un mil siete", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(1015).build();
        assertEquals("un mil quince", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(1821).build();
        assertEquals("un mil ochocientos veintiuno", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(9000).build();
        assertEquals("nueve mil", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(11942).build();
        assertEquals("once mil novecientos cuarentidos", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(325999).build();
        assertEquals("trescientos veinticinco mil novecientos noventinueve", converter.toLetter());
        converter = new SpanishNumber2LetterBuilder(999999).build();
    ...
    public void testNumberWithCurrency() throws NumberConversionException {
        converter = new SpanishNumber2LetterBuilder(new BigDecimal("1250.85")).currency("cordoba(s)").build();
    ...
    public void testNumberOutOfBounds() throws NumberConversionException {
        new SpanishNumber2LetterBuilder(1_000_000_000).build();
    }
}
